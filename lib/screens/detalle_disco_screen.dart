...
import '../core/image_proxy.dart';           // 👈 importante
...
class DetalleDiscoScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Obtenemos versión fresca (pudo cambiar favorito, etc.)
              ...
              children: [
                Center(
                  child: ClipRRect(
                    ...
                    child: Image.network(
                      proxiedImage(updatedRecord.portadaUrl),   // 👈 aquí el proxy
                      height: 220,
                      fit: BoxFit.cover,
                ...
                if (updatedRecord.descripcion.isNotEmpty) ...[
                  ...
                  Text(updatedRecord.descripcion, style: Theme.of(context).textTheme.bodyMedium),
                ],
              ],
            ),
          ),
